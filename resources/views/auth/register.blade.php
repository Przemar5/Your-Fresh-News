            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="info" class="col-md-4 col-form-label text-md-right">{{ __('About*') }}</label>

                            <div class="col-md-6">
                                <textarea id="info" class="form-control @error('info') is-invalid @enderror" name="info" value="{{ old('info') }}" autocomplete="about" rows="7" style="resize: none;"></textarea>
